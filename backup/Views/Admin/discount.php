            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Discount</h1>
                    </div>
                    ...
                    <div class="row">
                        <div class="container my-5">
                            <div class="d-flex justify-content-between mb-3">
                                <a href="tambah_produk.php" class="btn btn-success" data-toggle="modal" data-target="#modalTambahDiskon">
                                    <i class="fas fa-plus-circle"></i> Tambah Discount
                                </a>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <td>Rp 550.000</td>
                                    <td><p style="color:green">20%</p></td>
                                    <td>Rp 440.000,00</td>
